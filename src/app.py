                    ...
                    [
                        dbc.DropdownMenu(
                            [
                                ...
                                dbc.DropdownMenuItem(divider=True),
                                dbc.DropdownMenuItem('Simple Inventory Tracking', href='https://docs.google.com/spreadsheets/d/1l7AEziSlo6gbKVivKezmFwOsiO49WTZBmUmoM8YgzO4/edit?usp=sharing'),
                                dbc.DropdownMenuItem(divider=True),
                            ], label='More',
                        )
                    ]
